...
var gameLoaded = function () {
  ...
  var lastInputTime = 0;
  var triggerPound = function (e) {
    if (e && e.target && e.target === playagain.img) {
      return;
    }
    var now = Date.now();
...
playagain.img.addEventListener('touchstart', function (e) {
  if (e && e.cancelable) {
    e.preventDefault();
  }
  e.stopPropagation();
...
playagain.img.addEventListener('pointerdown', function (e) {
  if (e && e.pointerType === 'touch') {
    if (e.cancelable) {
      e.preventDefault();
    }
